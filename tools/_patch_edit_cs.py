...
p = Path(r'C:\\Users\\neura\\repos\\audio-device-switcher\\src\\AudioProfiles\\Views\\EditProfilePage.xaml.cs')
...
public sealed partial class EditProfilePage : Page
{
    ...
    {
        InitializeComponent();
        BackButton.Content = Loc.Get("Back");
...
''', encoding='utf-8')
print('EditProfilePage.xaml.cs written', p.stat().st_size)
