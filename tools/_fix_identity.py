...
Path(r"C:\Users\neura\repos\audio-device-switcher\src\AudioProfiles\Services\AppIdentity.cs").write_text(r'''using System.Runtime.InteropServices;
    ...
    public static void RestoreNotificationIdentity()
    {
        ...
        try
        {
            ...
            if (File.Exists(iconPath))
            {
                ...
                key.SetValue("IconBackgroundColor", "0F6B6B");
            }
